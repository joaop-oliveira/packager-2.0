...
var fstream = __webpack_require__("fstream");
var tar = __webpack_require__("tar");
//declare statements
...
var createPackage = function createPackage(inputPath, req, res) {
    ...
    try {
        ...
        if (shell.exec('echo "zip -r -9 ' + __dirname + '/packages/' + currentDate + '/package-' + req.body.version + '.zip  ' + __dirname + inputPath + '"').code === 0) {
            res.status(200).send({
...
//# sourceMappingURL=0.b7f43a95213fd8dc34ba.hot-update.js.map